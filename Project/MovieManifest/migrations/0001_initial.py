    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='MovieManifest.ticker')),
            ],
            options={
                'db_table': 'options',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prices', to='MovieManifest.option')),
            ],
            options={
                'db_table': 'option_prices',
                'indexes': [models.Index(fields=['option', 'date_collected'], name='option_pric_option__8bc3e8_idx')],
